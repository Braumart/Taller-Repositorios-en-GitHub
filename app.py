...
def load_data():
    """
    Carga los datos desde 'datos_energia.csv', convierte la columna 'time'
    ...
    # Asegúrate de que tu archivo CSV tenga una columna llamada 'time'.
    # Si tiene otro nombre (ej. 'fecha'), cámbialo aquí.
